...
class _InventoryApi implements InventoryApi {
  ...
  @override
  Future<InventoryEnvelopeDto> getInventory(Map<String, dynamic> body) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    final _data = <String, dynamic>{};
    _data.addAll(body);
    final _options = _setStreamType<InventoryEnvelopeDto>(
    ...
    late InventoryEnvelopeDto _value;
    try {
      _value = InventoryEnvelopeDto.fromJson(_result.data!);
    } on Object catch (e, s) {
...
String _$inventoryApiHash() => r'6019493aac048230d22d4474a5403437d921b61a';
